...
<head>
   ...
   <!-- link of jquery -->
    ...
    <!-- cdn of fontawesome -->
    <script  type="text/javascript" src="https://kit.fontawesome.com/c0e09bf677.js" crossorigin="anonymous"></script>
    <!-- cdn of adminLTE -->
...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="position:fixed;top:0; left:0; height:100%;overflow-y:auto;">
  ...
  <a href="index3.html" class="brand-link">
    <img src="Screenshot_20230826-002159.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">Shiela Marie</span>
  </a>
...
<!-- /.navbar -->
<div class="card card-success content-wrapper">
  ...
  <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas id="myChart" style="max-height: 500px; max-width: 100%; display: block; width: 487px;" class="chartjs-render-monitor"></canvas>
  </div>
</div>
