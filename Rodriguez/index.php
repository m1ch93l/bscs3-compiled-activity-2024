...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="position:fixed;top:0,left:0;height:100%overflow-y:auto;">
  ...
  <a href="index3.html" class="brand-link">
    <img src="ako.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
         style="opacity: .8">
    <span class="brand-text font-weight-light">Justine Rodriguez</span>
  </a>
</a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
      <img src="ako.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"style="left: 12px"></div>
      <div class="info">
        <a href="#" class="d-block">Justine</a>
      </div>
    </div>
