...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <img src="img/tulip.jpg" alt="AdminLTE Docs Logo Small" class="brand-image-xl logo-xs">
  <img src="img/tulip.jpg" alt="AdminLTE Docs Logo Large" class="brand-image-xs logo-xl" style="left: 12px">
</a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="img/tulip.jpg" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
        <a href="#" class="d-block">Jaysan Pontillas</a>
      </div>
    </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Home - Moving Bar Chart</title>
...
<body>
    ...
    <h1>Moving Bar Chart Example</h1>
